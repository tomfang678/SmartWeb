...
function createList(Data) {
    ...
    $.each(Data, function (index, value) {
        ...
        html += "<dl><dt> <a href='/Staff/StarDetail?staffid=" + value.id + "'><img src=" + value.imgurl + " alt='" + value.title + "' title='" + value.title + "'style='width:190px; height:160px' /></a></dt><dd><font face=Verdana><font face=Verdana><span style='font-size:13px;font-weight:bold'>" + value.title + "</span>" + desc + "</font></font> </dd> </dl><div class='line-gray'></div>";
    });

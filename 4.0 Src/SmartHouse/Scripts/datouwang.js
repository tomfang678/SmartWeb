            ...
            var e = d(this),
                ...
                t = function(a) {
                    ...
                    f.stop().fadeOut(q, function() {
                        ...
                        $(".imgLoadAmin").show();
                        var src = d(this).find("img").attr("data-src");
                        d(this).find("img").attr("src", src);
                        d(this).find("img").load(function () {
                            $(".imgLoadAmin").hide();
                        })
                       
                        d(this).find("img").removeAttr("data-src");

...
namespace Smart.Framework.Utility
{
    ...
    public class Encrypt
    {
        ...
        public static string Encode(string encryptString, string encryptKey = "shudao16")
        {
        ...
        public static string Decode(string decryptString, string decryptKey = "shudao16")
        {
            try
            {
